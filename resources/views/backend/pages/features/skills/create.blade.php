            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-12">
                        <!--begin::Form-->
                        <form action="{{ route('backend.features.skills.store') }}" method="POST"
                            ...
                            <div class="mb-0">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input
                                        ...
                                        id="skill" type="text" name="skill" value="{{ old('skill') }}" required
                                        autocomplete="skill" placeholder="Enter skill" autofocus />
                                    <!--end::Input-->
                                    @error('skill')
