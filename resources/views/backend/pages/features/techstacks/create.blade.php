            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-12">
                        <!--begin::Form-->
                        <form action="{{ route('backend.features.techstacks.store') }}" method="POST"
                            ...
                            <div class="mb-0">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input
                                        ...
                                        id="techstack" type="text" name="techstack" value="{{ old('techstack') }}"
                                        required autocomplete="techstack" placeholder="Enter techstack" autofocus />
                                    <!--end::Input-->
                                    @error('techstack')
