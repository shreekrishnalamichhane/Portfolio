            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-12">
                        <!--begin::Form-->
                        <form action="{{ route('backend.features.sociallinks.update', $data['sociallink']?->id) }}"
                            ...
                            <div class="mb-0">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input
                                        ...
                                        value="{{ $data['sociallink']?->name }}" required autocomplete="name"
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input
                                        ...
                                        value="{{ $data['sociallink']?->link }}" required autocomplete="link"
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input
                                        ...
                                        value="{{ $data['sociallink']?->order }}" autocomplete="order"
