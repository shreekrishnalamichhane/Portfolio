            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-12">
                        <!--begin::Form-->
                        <form action="{{ route('backend.features.projects.update', $data['project']?->id) }}" method="POST"
                            ...
                            <div class="mb-0">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input
                                        ...
                                        id="title" type="text" name="title" value="{{ $data['project']?->title }}"
                                        required autocomplete="title" placeholder="Enter title" />
                                    <!--end::Input-->
                                    @error('title')
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <textarea name="description" class="form-control form-control-solid @error('description') is-invalid @enderror"
                                        id="description" placeholder="Enter description" rows="5" required>{{ $data['project']?->description }}</textarea>
                                    <!--end::Textarea-->
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input
                                        ...
                                        id="source" type="url" name="source"
                                        value="{{ $data['project']?->source }}" autocomplete="source"
